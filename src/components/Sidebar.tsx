...
const nav: NavItem[] = [
  ...
  { href: "/manual",       label: "Manual do Aluno",      icon: "📕", roles: ["ADMINISTRADOR", "CHEFE_DIVISAO_ACADEMICA", "COMANDANTE_ESFO", "SUBCOMANDANTE_ESFO", "COMANDANTE_ESFAP", "SUBCOMANDANTE_ESFAP"] },
